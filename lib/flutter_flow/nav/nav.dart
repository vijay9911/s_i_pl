...
class AppStateNotifier extends ChangeNotifier {
  SIPlFirebaseUser? initialUser;
  SIPlFirebaseUser? user;
  ...
  void update(SIPlFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) =>
          appStateNotifier.loggedIn ? HomePageAlt1Widget() : OnboardingWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          builder: (context, params) => RegisterAccountWidget(
            userreferralp: params.getParam('userreferralp', ParamType.String),
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: '/withdr',
          requireAuth: true,
          builder: (context, params) => WithdrWidget(),
        ),
        FFRoute(
          name: 'DEPOSIT',
          path: '/deposit',
        ...
        FFRoute(
          ...
          requireAuth: true,
          builder: (context, params) => UserVerificationWidget(
            kycDoc: params.getParam('kycDoc', ParamType.String),
          ),
        )
